...
// fixture 1
@Component({
  template: `<che-input desing="borderless" color="color" label="The label" ></che-input>`
})
class CheInputF1Component {}

// fixture 2
@Component({
    template: `<che-input type="number" ></che-input>`
})
class CheInputF2Component {}

// fixture 3
@Component({
  template: `<che-input type="password" ></che-input>`
})
class CheInputF3Component {}

// fixture 4
@Component({
    template: `<che-input desing="borderless" color="color" label="The label" [required]="true"></che-input>`
})
class CheInputF4Component {}

// fixture 5
@Component({
    template: `<che-input desing="borderless" color="color" label="The label" placeholder="this is a placeholder"></che-input>`
})
class CheInputF5Component {}

// fixture 6
@Component({
    template: `<che-input desing="borderless" color="color" label="The label" [disabled]="true"></che-input>`
})
class CheInputF6Component {}

// fixture 7
@Component({
    template: `<che-input desing="borderless" color="color" label="The label" [readonly]="true"></che-input>`
})
class CheInputF7Component {}

// fixture 8
@Component({
    template: `<che-input color="color" label="The label"></che-input>`
})
class CheInputF8Component {}

// fixture 9
@Component({
    template: `<che-input  color="color" label="The label" [required]="true"></che-input>`
})
class CheInputF9Component {}

// fixture 10
@Component({
    template: `<che-input color="color" label="The label" placeholder="this is a placeholder"></che-input>`
})
class CheInputF10Component {}

// fixture 11
@Component({
    template: `<che-input color="color" label="The label" [disabled]="true"></che-input>`
})
class CheInputF11Component {}

// fixture 12
@Component({
    template: `<che-input color="color" label="The label" [readonly]="true"></che-input>`
})
class CheInputF12Component {}

// fixture 13
@Component({
    template: `<che-input desing="borderless" label="The label" ></che-input>`
})
class CheInputF13Component {}

// fixture 14
@Component({
    template: `<che-input label="The label" ></che-input>`
})
